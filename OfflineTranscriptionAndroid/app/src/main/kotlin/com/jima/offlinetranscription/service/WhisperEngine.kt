 ...
 * Playback state callback is kept for compatibility with existing engine logic.
 */
private class AndroidTtsService(@Suppress("UNUSED_PARAMETER") context: Context) {
    ...
    fun speak(
        ...
        @Suppress("UNUSED_PARAMETER") rate: Float
    ) {
    ...
    fun latestEvidenceFilePath(): String? = null
...
class WhisperEngine(
    ...
    private val _speakTranslatedAudio = MutableStateFlow(false)
